...
% Thu Sep 15 09:19:53 2016
% update schedule + some more material for programmation paradigms
% Wed Sep 13 09:26:12 2017
% update schedule and delete ``exercice d'exemen" 
...
\deftranslation[to=french]{Outline}{Plan de cours}
...
toutes les séances sont de 10h45 à 12h45

\bgroup
% \rowcolors{1}{white}{gray} clashes later
\begin{tabular}{llll}
L & 18/09 & Chap. 1 + 2 & Mercator B336 \\
V & 22/09 & Chap. 2 + 3 & MERC20 \\
\hline
L & 25/09 & Chap. 4 & Mercator B336 \\
V & 29/09 & Exo S\'eance 1  & MERC20 \\
\hline
L & 02/10 & Chap. 5 & Mercator B336 \\
V & 06/10 & Exo S\'eance 2 & MERC20 \\
\hline
L & 09/10 & Exo S\'eance 3 & Ferraris\\
V & 13/10 & Exo S\'eance 4 & Ferraris \\
\hline
L & 16/10 & Chap. 6        &  Mercator B336 \\
V & 20/10 & Exo S\'eance 5 & MERC20 \\
\hline
L & 23/10 & Prédictability & Mercator B336 \\
V & 27/10 & Exo S\'eance 6 & Ferraris \\
\end{tabular}
\egroup
\end{frame}
...
Il existe des dizaines de languages de programmation ! 

\begin{itemize}
\item \emph{Compilé} (C, C++, Fortran) ou \emph{interprété} (Python, Guile, MATLAB, R)
...
avec toutes les nuances (e.g: Perl, Python, php peuvent être utilisés de façon procédurale, fonctionnelle, orienté objet ou non, et sont compilés en ``bytecode")
...
%  Comparez les résultats obtenus avec les schémas de Heun, de Verlet et d'Euler symplectique. Les deux premiers schémas ont été vus au  cours. Concentrez votre analyse sur les invariants du système (intégrales premières).
%\end{exerciceexamen}
%
%\end{frame}
%
